...
class PoisonedDnsResponseFilter {
    private val bogusIps = ConcurrentHashMap<String, Boolean>()
    ...
    init {
        ...
        for (ip in knownBogus) {
            bogusIps[ip] = true
        }
    }

    fun isBogus(ip: String): Boolean = bogusIps[ip.trim()] == true

    fun filterIps(candidateIps: List<String>): List<String> {
